      ...
      async addUser(e){
          ...
          if (!(this.user.userName&&this.user.phone&&this.user.password&&this.user.confirm&&this.user.type
            ...
            alert("两次密码输入不一致");
             ...
             //const  web4 = new Web3(window.web3.currentProvider);
             //console.log(web4);
...
/* 设置背景图像 */  
.registry {  
  background-image: url('../img/banner11.jpg'); /* 替换为你的背景图片路径 */  
...
/* 容器样式 */  
.container {  
  background-color: rgba(255, 255, 255, 0.3); /* 半透明白色背景，以便看到背景图像 */  
  border-radius: 10px;  
  padding: 30px;  
